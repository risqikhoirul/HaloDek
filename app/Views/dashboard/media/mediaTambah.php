    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Menambahkan konten seputar kesehatan.</p>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tambah Content</h4>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <form method="post" action="/dashboard/mediakesehatan/tambah/add">
                                <div class="form-group">
                                    <label for="basicNama">Judul</label>
                                    <input type="text" class="form-control <?= $errorMessage ? 'is-invalid' : '' ?>" id="basicNama" name="title" placeholder="Enter judul">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="full" style="min-height: 160px;"></div>
                                    </div>
                                </div>
